...
from lucy_speech.inference_engine.reference_loader import ReferenceLoader
from lucy_speech.inference_engine.utils import InferenceResult, wav_chunk_header
from lucy_speech.inference_engine.vq_manager import VQManager
from lucy_speech.models.dac.modded_dac import DAC
from lucy_speech.models.text2semantic.inference import (
    GenerateRequest,
    GenerateResponse,
    WrappedGenerateResponse,
)
from lucy_speech.utils import autocast_exclude_mps, set_seed
from lucy_speech.utils.schema import ServeTTSRequest
...
class TTSInferenceEngine(ReferenceLoader, VQManager):
    ...
    def inference(self, req: ServeTTSRequest) -> Generator[InferenceResult, None, None]:
        ...
        while True:
            ...
            if result.action != "next":
                ...
                if result.codes is not None:
                    token_total += int(result.codes.shape[1])
        ...
        if len(segments) == 0:
            ...
            audio_sec = float(audio.shape[0] / sample_rate)
            tokens_per_sec = token_total / elapsed if elapsed > 0 else None
            yield InferenceResult(
                code="final",
