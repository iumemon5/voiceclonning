...
from lucy_speech.models.text2semantic.lora import LoraConfig, setup_lora
from lucy_speech.tokenizer import SEMANTIC_TOKENS, LucyTokenizer
...
class BaseTransformer(nn.Module):
    ...
    def from_pretrained(
        ...
        tokenizer = LucyTokenizer.from_pretrained(path)
...
class NaiveTransformer(BaseTransformer):
    def __init__(self, config: NaiveModelArgs, tokenizer: LucyTokenizer) -> None:
