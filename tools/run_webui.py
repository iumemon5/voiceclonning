...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        default="checkpoints/lucy5",
    )
    parser.add_argument(
        "--decoder-checkpoint-path",
        type=Path,
        default="checkpoints/lucy5/codec.pth",
    )
    ...
    parser.add_argument("--port", type=int, default=8065, help="Server port")
    parser.add_argument(
        "--share",
        action="store_true",
        default=True,
        help="Enable Gradio public share link (default on)",
    )
    parser.add_argument(
        "--no-share",
        dest="share",
